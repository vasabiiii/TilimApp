...
class _LoginScreenState extends State<LoginScreen>
  ...
  late BoxDecoration _formDecoration;
  ...
  void _initializeStyles() {
    ...
    _subtitleStyle = const TextStyle(
      fontSize: 16,
      color: Colors.grey,
    );
    _formDecoration = BoxDecoration(
  ...
  void didChangeDependencies() {
    ...
    final double titleFontSize = _screenSize.width < 350 ? 24 : 
                                _screenSize.width < 400 ? 26 : 28;
                    ...
                    child: GestureDetector(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          style: _subtitleStyle,
                          children: [
                            const TextSpan(text: 'Еще нет аккаунта? '),
                            TextSpan(
